...
func TestRandomizedGenState(t *testing.T) {
	...
	assert.Len(t, bankGenesis.Params.GetSendEnabled(), 0, "Params.GetSendEnabled") //nolint:staticcheck // SA1019: bankGenesis.Params.GetSendEnabled is deprecated: SendEnabled is deprecated
