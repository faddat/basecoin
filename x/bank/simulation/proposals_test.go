...
func TestProposalMsgs(t *testing.T) {
	...
	assert.Assert(t, len(msgUpdateParams.Params.SendEnabled) == 0) //nolint:staticcheck // SA1019: msgUpdateParams.Params.SendEnabled is deprecated: SendEnabled is deprecated
